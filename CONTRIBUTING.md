...
Thank you for your interest in `strong-service-systemd`, an open source project
administered by StrongLoop.

Contributing to `strong-service-systemd` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/strong-service-systemd)
